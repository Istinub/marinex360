...
function seedJobOrderCache(db, jo) {
  db.jo_cache.set(jo.id, {
    ...
    branch: jo.branch,
    client_id: jo.clientId ?? null,
    vessel_id: jo.vesselId ?? null,
    vendor_id: jo.vendorId ?? null,
    is_subcontracted: jo.isSubcontracted ? 1 : 0,
    ...
    quoted_currency: jo.quotedCurrency ?? null,
